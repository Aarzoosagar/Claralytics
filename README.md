...
> **AWS Cloud Edition:** this version adds production AWS deployment support —
> EC2 hosting, S3-backed dataset/report storage, IAM-role-based auth (no
> access keys), and CloudWatch logging/monitoring — without changing any
> frontend code or existing functionality. See **[`deploy/README.md`](deploy/README.md)**
> for the full phase-by-phase setup guide, and `backend/.env.example` for
> configuration. Everything still runs locally with zero AWS setup by leaving
